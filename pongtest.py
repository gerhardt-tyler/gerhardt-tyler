...
pen.hideturtle()
pen.goto(0,260)
pen.write("score",align="center",font=("Arial",26,"normal"))
...
while True:
  ...
  if ball.xcor()>390:
    ...
    pen.clear()
    pen.write("player A:{}    player B:{}".format(playerAscore,playerBscore),align="center",font=("Arial",26,"normal"))
